...
4. Note the name of your repository `URL` here: **<https://github.com/SYC20148007/ICT40120-IP4RIoT-Session-06>**
...
```bash
git remote add origin <https://github.com/SYC20148007/ICT40120-IP4RIoT-Session-06>
```
...
---
   git pull copies changes from a remote repository directly into your work directory, while git fetch dosn't
---
